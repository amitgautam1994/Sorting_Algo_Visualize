...
def drawData(data, colorName):
    ...
    for i, height in enumerate(normalizedData):
        ...
        canvas.create_rectangle(x0, y0, x1, y1, fill=colorName[i])
...
speedScale = Scale(UI_frame, from_=0.1, to=4.0, length=200, digits=2, resolution=0.2, orient=HORIZONTAL,
